...
public class modelo_Material {
	...
	public modelo_Material(int codigo, String titulo, String[] autores, String tipo_recurso, String editorial, Date fecha_publicacion, int numero_paginas, String detalle_publicacion, String biblioteca) {
		this.codigo = codigo;
		this.titulo = titulo;
